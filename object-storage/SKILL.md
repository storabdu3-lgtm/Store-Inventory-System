---
name: object-storage
description: Object storage (App Storage) for persistent files (images, audio, video, and documents) in pnpm monorepo web apps. Use expo_object_storage for Expo/React Native instead.
---
...
- The app must persist user-uploaded or app-generated files, even when the user does not name a storage service

## When NOT to Use

- User only needs to render images from given URLs (no storage needed)
- User needs AI-generated images only for immediate use and the app does not persist them
